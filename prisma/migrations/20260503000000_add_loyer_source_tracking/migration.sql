...
--     -c "SET search_path TO immo_score;" \
--     -f /chemin/vers/migration.sql
-- OU via Prisma (une fois le schéma migrations initialisé) :
...
ALTER TABLE "loyer_communes" ADD COLUMN IF NOT EXISTS "nbObs"     INTEGER;
ALTER TABLE "loyer_communes" ADD COLUMN IF NOT EXISTS "q1M2"      DECIMAL(6,2);
ALTER TABLE "loyer_communes" ADD COLUMN IF NOT EXISTS "q3M2"      DECIMAL(6,2);
